...
// Function to handle signup (store user data in local storage)
function signup(event) {
  ...
  msg.innerHTML = `Successfully registered as ${name}`;
}

// Function to handle login (validate credentials)
function login(event) {
  ...
  if (email === storedEmail && password === storedPassword) {
      window.location.href = "symptom.html"; // Redirect after successful login
  } else {
